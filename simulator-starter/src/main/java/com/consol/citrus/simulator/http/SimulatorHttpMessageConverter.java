...
/**
 * Special generic message converter only applies to {@link HttpMessageController} context class when reading and writing data.
...
public class SimulatorHttpMessageConverter implements GenericHttpMessageConverter<Object> {
    ...
    public boolean canRead(Type type, Class contextClass, MediaType mediaType) {
        return contextClass.equals(HttpMessageController.class);
    }
