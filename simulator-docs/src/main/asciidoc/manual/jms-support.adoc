...
[source,java]
----
import com.consol.citrus.simulator.annotation.EnableJmsSimulation;
...
The *@EnableJmsSimulation* annotation performs some auto configuration steps and loads required beans for the Spring application context
