...
citrus.simulator.jms.receiveDestination:: JMS destination name to consume inbound messages from
citrus.simulator.jms.sendDestination:: JMS destination name to publish outbound messages to
