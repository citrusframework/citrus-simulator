...
by using further annotations provided. In the sample above we use the *@EnableRestSimulation* annotation for Http REST endpoint support.

There are multiple annotations available for different transport endpoints:

.Simulator annotations
[horizontal]
@EnableRestSimulation:: Enables link:#rest-support[Http REST support]
@EnableWebServiceSimulation:: Enables link:#ws-support[SOAP web services support]
@EnableWebServiceClientSimulation:: Enables link:#ws-support[SOAP web services support]
@EnableJmsSimulation:: Enables link:#jms-support[JMS support]
@EnableEndpointSimulation:: Enables generic link:#endpoint-component-support[endpoint component support]
