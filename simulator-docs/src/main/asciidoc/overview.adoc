...
|3.0.0-SNAPSHOT	|link:/citrus-simulator/reference/3.0.0-SNAPSHOT/html/index.html[HTML] |link:/citrus-simulator/reference/3.0.0-SNAPSHOT/pdf/citrus-simulator-reference-3.0.0-SNAPSHOT.pdf[PDF]
