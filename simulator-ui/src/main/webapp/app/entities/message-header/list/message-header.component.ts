...
export class MessageHeaderComponent implements OnInit {
  ...
  messageHeaders = signal<IMessageHeader[]>([]);
  isLoading = false;
  ...
  protected readonly messageHeaderService = inject(MessageHeaderService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected ngZone = inject(NgZone);

  trackId = (item: IMessageHeader): number => this.messageHeaderService.getMessageHeaderIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.messageHeaders.set(dataFromBody);
  }
