...
export class TestParameterComponent implements OnInit {
  ...
  testParameters = signal<ITestParameter[]>([]);
  isLoading = false;
  ...
  trackId = (item: ITestParameter): number => this.testParameterService.getTestParameterIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.testParameters.set(dataFromBody);
  }
