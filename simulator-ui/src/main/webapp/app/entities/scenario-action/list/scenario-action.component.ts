...
export class ScenarioActionComponent implements OnInit {
  ...
  scenarioActions = signal<IScenarioAction[]>([]);
  isLoading = false;
  ...
  protected readonly scenarioActionService = inject(ScenarioActionService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected ngZone = inject(NgZone);

  trackId = (item: IScenarioAction): number => this.scenarioActionService.getScenarioActionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.scenarioActions.set(dataFromBody);
  }
