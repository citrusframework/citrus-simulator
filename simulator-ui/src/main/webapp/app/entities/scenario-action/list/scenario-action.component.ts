...
export class ScenarioActionComponent implements OnInit {
  ...
  sortState = sortStateSignal({ predicate: 'actionId' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.scenarioActions = this.fillComponentAttributesFromResponseBody(response.body);
  }
