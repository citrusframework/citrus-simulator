...
export class ScenarioParameterComponent implements OnInit {
  ...
  scenarioParameters = signal<IScenarioParameter[]>([]);
  isLoading = false;
  ...
  protected readonly scenarioParameterService = inject(ScenarioParameterService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected ngZone = inject(NgZone);

  trackId = (item: IScenarioParameter): number => this.scenarioParameterService.getScenarioParameterIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.scenarioParameters.set(dataFromBody);
  }
