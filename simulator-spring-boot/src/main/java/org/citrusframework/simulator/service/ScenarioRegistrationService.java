...
public class ScenarioRegistrationService {
    ...
    public SimulatorScenario registerScenarioFromJavaSourceCode(String scenarioName, String javaSourceCode) {
        try {
            ...
            if (simulatorScenario instanceof SimpleInitializedSimulatorScenario simpleInitializedSimulatorScenario) {
                simpleInitializedSimulatorScenario.setScenarioEndpoint(new ScenarioEndpoint(new ScenarioEndpointConfiguration()));
            }
