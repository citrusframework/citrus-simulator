...
public class ScenarioResource {
    ...
    public ScenarioResource(Client openFeatureClient, ScenarioExecutorService scenarioExecutorService, ScenarioLookupService scenarioLookupService, ScenarioRegistrationService scenarioRegistrationService, ScenarioParameterMapper scenarioParameterMapper) {
    ...
    public ResponseEntity<?> uploadScenario(@PathVariable("scenarioName") String scenarioName, @RequestBody String javaSourceCode) {
        if (!openFeatureClient.getBooleanValue(EXPERIMENTAL_SCENARIO_LOADING_AT_RUNTIME_ENABLED, false)) {
